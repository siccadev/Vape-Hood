  ...
  return (
    <div className="flex full_container">
      ...
      <div className="  py-8 px-2  main_width">
        ...
        <p className="text-center text-gray-500 mb-8">Bienvenue dans notre collection d{"'"}atomiseurs, conçue pour les passionnés de la vape en Tunisie. Chez [VapeHood], nous vous proposons une sélection soigneusement choisie d{"'"}atomiseurs de qualité, (Atomiseurs Sub-ohm ,RDTA ,RTA et Atomiseurs MTL).</p>

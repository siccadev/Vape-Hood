...
const products = [
  ...
  { id: 11, name: 'RÉSISTANCES TPP SERIE DM VOOPOO (x3)', image: '/resistances-tpp-serie-dm-voopoo-x3 (1).webp', originalPrice: '45,000 TND', Catégories: "Mesh", Disponibilité: "En stock", Marque: "VOOPOO", Description: "Vendues par 5, les TPP SERIE DM sont des résistances développées par VOOPOO .DM1 : 0,15Ω 60-80WDM2 : 0,2Ω 40-60WDM4 : 0,2Ω MAX 40W Compatible Atomiseurs TPP" },

  { id: 13, name: 'RÉSISTANCES GT CCELL VAPORESSO (x3)', image: '/resistances-gt-ccell-vaporesso-x3.webp', originalPrice: '45,000 TND', Catégories: "Mesh", Disponibilité: "En stock", Marque: "VAPORESSO", Description: "Pack renfermant 3 résistances GT du célèbre fabricant Vaporesso. Ces résistances de haut vol sont destinées à être installées sur les clearomiseurs NRG PE, NRG SE ,NRG Tank, SKrr-S, SKrr-S Mini, Fat Rabbit et le kit Cascade One." },
  { id: 14, name: 'RÉSISTANCES GT CCELL2 VAPORESSO (x3)', image: '/resistances-gt-ccell2-vaporesso-x3.webp', originalPrice: '45,000 TND', Catégories: "Mesh", Disponibilité: "En stock", Marque: "VAPORESSO", Description: "Pack renfermant 3 résistances GT du célèbre fabricant Vaporesso. Ces résistances de haut vol sont destinées à être installées sur les clearomiseurs NRG PE, NRG SE ,NRG Tank, SKrr-S, SKrr-S Mini, Fat Rabbit et le kit Cascade One" },


  { id: 17, name: 'Accu 18650 3000mah / 35A - MXJO', image: '/accu-18650-3000mah-35a-mxjo.webp', originalPrice: '35,000 TND', Catégories: "Accu", Disponibilité: "En stock", Marque: "MXJO", Description: "Il semble que vous partagiez des informations détaillées sur les batteries MXJO 18650 3000 mAh, en mettant l'accent sur leur qualité, leurs performances et leurs caractéristiques techniques. Voici un résumé des points clés que vous avez mentionnés :Caractéristiques des batteries MXJO 18650 3000 mAh :Capacité : 3000 mAhType : IMR 18650Tension de charge : 3,7 +/-0,05 VCourant de décharge continu : 20 ACourant de décharge maximum : 35 ALongueur : 65 mm (+/-0,05) mmDiamètre : 18 mm (+/-0,05) mmCharge standard : CC/CV 1.50A, 4.20 ± 0.05 VPoids : 60 gFabricant : MXJO" },
  ...
  { id: 23, name: 'TRI CORE FUSED CLAPTON PREBUILT COILS 0.17ohm 10PCS - WOTOFO', image: '/tri-core-fused-clapton-prebuilt-coils-017ohm-10pcs-wotofo.webp', originalPrice: '40,000 TND', Catégories: "Coil", Disponibilité: "En stock", Marque: "WOTOFO", Description: "TRI CORE FUSED CLAPTON PREBUILT COILS 0.17OHM 10PCS - WOTOFO" },
  { id: 24, name: 'FUSED CLAPTON 0,50OHM COILS 10PCS - WOTOFO', image: '/fused-clapton-050ohm-coils-10pcs-wotofo.webp', originalPrice: '40,000 TND', Catégories: "Coil", Disponibilité: "En stock", Marque: "WOTOFO", Description: "FUSED CLAPTON 0,50OHM COILS 10PCS - WOTOFO" },
  { id: 25, name: 'DUAL CORE FUSED CLAPTON PREBUILT COILS 10PCS 0.28OHM - WOTOFO', image: '/dual-core-fused-clapton-prebuilt-coils-10pcs-028ohm-wotofo (1).webp', originalPrice: '40,000 TND', Catégories: "Coil", Disponibilité: "En stock", Marque: "WOTOFO", Description: "DUAL CORE FUSED CLAPTON PREBUILT COILS 10PCS 0.28OHM - WOTOFO" },


  { id: 28, name: 'ORG - C - Organic Cotton 17g - E-Cig Power', image: '/fiber-n-cotton-v2-fiber-n-cotton.webp', originalPrice: '35,000 TND', Catégories: "Cotton", Disponibilité: "En stock", Marque: "E-Cig Power", Description: "" },
  { id: 29, name: 'Fiber nCotton V2 - Fiber n Cotton', image: '/fiber-n-cotton-v2-fiber-n-cotton (1).webp', originalPrice: '35,000 TND', Catégories: "Cotton", Disponibilité: "En stock", Marque: " N° COTTON" },
